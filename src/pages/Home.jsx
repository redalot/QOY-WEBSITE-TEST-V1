    ...
    <div className="bg-slate-900 text-white min-h-screen">
      ...
      <section className="relative h-[85vh] flex items-center justify-center bg-gradient-to-br from-cavalry-blue via-blue-950 to-black overflow-hidden border-b-4 border-qoy-yellow">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          ...
          >
            <img src={`${import.meta.env.BASE_URL}qoy-badge.jpg`} alt="QOY Badge" className="mx-auto w-32 h-32 md:w-56 md:h-56 mb-8 rounded-full border-4 border-qoy-yellow shadow-[0_0_50px_rgba(255,215,0,0.3)] animate-pulse-slow" />
      ...
      <section className="py-24 bg-slate-800 border-y border-white/5">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <GalleryImg src={`${import.meta.env.BASE_URL}gallery-1.jpg`} />
            <GalleryImg src={`${import.meta.env.BASE_URL}gallery-2.jpg`} />
            <GalleryImg src={`${import.meta.env.BASE_URL}gallery-3.jpg`} />
            <GalleryImg src={`${import.meta.env.BASE_URL}gallery-4.jpg`} />
          </div>
        </div>
      </section>
